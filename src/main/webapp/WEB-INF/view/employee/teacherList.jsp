					...
					<div class="pcoded-content">
                        ...
                        <div class="pcoded-inner-content">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>강사 목록</h5>
                                                <a class="ml-3 btn btn-sm btn-outline-dark" href="${pageContext.request.contextPath}/employee/addTeacher"><i class="ti-plus"></i> 강사등록</a>
												<!-- 강사검색 -->
												<form method="get" action="${pageContext.request.contextPath}/employee/teacherList" class="mt-2 text-center form-material">
													<div class="form-group form-primary">
														...
														<input type="text" name="searchWord" placeholder="강사 찾기" value="${searchWord}" style="width:400px; background-color:#FFFFE4;" class="form-control ml-1">			
                                                        ...
                                                        <!-- 목록 출력 -->
															<c:forEach var="t" items="${list}">
																<tr>
																	...
																	<td>${t.teacherId}</td>
																	<td>${t.teacherName}</td>
																	<td><a href="${pageContext.request.contextPath}/employee/removeTeacher?teacherNo=${t.teacherNo}"><i class="ti-trash"></i></a></td>
																</tr>
															</c:forEach>
                                                        </tbody>
                                                    </table>
							...
							<div class="container text-center">
								<nav>
									<ul class="pagination">
										<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/teacherList?currentPage=1&searchWord=${searchWord}&rowPerPage=${rowPerPage}"><i class="ti-angle-double-left"></i></a></li>
										<c:if test="${currentPage > 10}">
											<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/teacherList?currentPage=${startPage-10}&searchWord=${searchWord}&rowPerPage=${rowPerPage}"><i class="ti-angle-left"></i></a></li>
										</c:if>
										<c:forEach var="i" begin="${startPage}" end="${endPage}" step="1">
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/teacherList?currentPage=${i}&searchWord=${searchWord}&rowPerPage=${rowPerPage}">${i}</a></li>
												</c:otherwise>
											</c:choose>
										</c:forEach>
										<c:if test="${(lastPage-startPage) > 10}">
											<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/teacherList?currentPage=${startPage+10}&searchWord=${searchWord}&rowPerPage=${rowPerPage}"><i class="ti-angle-right"></i></a></li>
										</c:if>
										<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/teacherList?currentPage=${lastPage}&rowPerPage=${rowPerPage}"><i class="ti-angle-double-right"></i></a></li>
									</ul>
								</nav>
							</div>
						</div>
