					...
					<div class="pcoded-content">
                        ...
                        <div class="pcoded-inner-content">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>학생 목록</h5>
                                                <a class="ml-3 btn btn-sm btn-outline-dark" href="${pageContext.request.contextPath}/employee/addStudent"><i class="ti-plus"></i> 학생등록</a>
												<!-- 학생검색 -->
												<form method="get" action="${pageContext.request.contextPath}/employee/studentList" class="mt-2 text-center form-material">
													<div class="form-group form-primary">
														...
														<input type="text" name="searchWord" placeholder="학생 찾기" value="${searchWord}" style="width:400px; background-color:#FFFFE4;" class="form-control ml-1">			
                                                        ...
                                                        <!-- 목록 출력 -->
															<c:forEach var="s" items="${list}">
																<tr>
																	...
																	<td>${s.studentId}</td>
																	<td>${s.studentName}</td>
																	<td><a href="${pageContext.request.contextPath}/employee/removeTeacher?sutdentNo=${s.studentNo}"><i class="ti-trash"></i></a></td>
																</tr>
															</c:forEach>
                                                        </tbody>
                                                    </table>
							...
							<div class="container text-center">
								<nav>
									<ul class="pagination">
										<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/studentList?currentPage=1&searchWord=${searchWord}&rowPerPage=${rowPerPage}"><i class="ti-angle-double-left"></i></a></li>
										<c:if test="${currentPage > 10}">
											<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/studentList?currentPage=${startPage-10}&searchWord=${searchWord}&rowPerPage=${rowPerPage}"><i class="ti-angle-left"></i></a></li>
										</c:if>
										<c:forEach var="i" begin="${startPage}" end="${endPage}" step="1">
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/studentList?currentPage=${i}&searchWord=${searchWord}&rowPerPage=${rowPerPage}">${i}</a></li>
												</c:otherwise>
											</c:choose>
										</c:forEach>
										<c:if test="${(lastPage-startPage) > 10}">
											<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/studentList?currentPage=${startPage+10}&searchWord=${searchWord}&rowPerPage=${rowPerPage}"><i class="ti-angle-right"></i></a></li>
										</c:if>
										<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/studentList?currentPage=${lastPage}&rowPerPage=${rowPerPage}"><i class="ti-angle-double-right"></i></a></li>
									</ul>
								</nav>
							</div>
						</div>
