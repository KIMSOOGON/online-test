...
<body>
	...
	<!-- 페이징 -->
	<div>
		<a href="${pageContext.request.contextPath}/employee/studentList?currentPage=1&searchWord=${searchWord}&rowPerPage=${rowPerPage}">첫</a>
		<c:if test="${currentPage > 1}">
			<a href="${pageContext.request.contextPath}/employee/studentList?currentPage=${currentPage-1}&searchWord=${searchWord}&rowPerPage=${rowPerPage}">◀</a>
		</c:if>
		...
		<a href="${pageContext.request.contextPath}/employee/studentList?currentPage=${lastPage}&searchWord=${searchWord}&rowPerPage=${rowPerPage}">끝</a>
	</div>
</body>
</html>