...
<body>
	...
	<c:if test="${wrongEmpPw eq 'wrongPw'}">
		<script>
								...
								<div class="row align-items-center">
									<div class="col-md-8">
										<div class="page-header-title">
											<h5 class="m-b-10">${loginEmp.empName}님 비밀번호 수정</h5>
											<p class="m-b-0">
											</p>
										</div>
									</div>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>${loginEmp.empName}님 비밀번호 수정</h5>
                                            ...
                                            <div class="card-block table-border-style">
                                            	<div class="table-responsive">
													<form id="modifyForm" action="${pageContext.request.contextPath}/employee/modifyEmpPw" method="post">
