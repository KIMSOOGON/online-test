...
<body>
	<h1>사원추가</h1>
	<form id="addForm" action="${pageContext.request.contextPath}/employee/addEmp" method="post">
		<div><!-- 아이디 -->
			<!-- 아이디 중복확인 modal -->
			...
			<input type="text" name="empId" id="id" readonly="readonly" placeholder="id">
			<a href="#ex1" rel="modal:open">중복확인</a>
		</div>
		<div><!-- 패스워드 -->
			<input type="password" id="pw" name="empPw" placeholder="password">
		...
		<div><!-- 이름 -->
			<input type="text" id="name" name="empName" placeholder="name">
