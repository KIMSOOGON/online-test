        ...
        <div class="container">
			<div class="row">
				<div class="col-sm-12">
					...
					<form id="loginForm" action="${pageContext.request.contextPath}/loginStudent" method="post" class="md-float-material form-material">
						    ...
						    <div class="card-block">
						        <div class="row m-b-20">
						            <div class="col-md-12">
						                ...
						                <p class="text-center text-success">학생 로그인
						                	<a style="float:left; background-color:#FFDEA9;" href="${pageContext.request.contextPath}/loginEmp" class="btn btn-sm">직원</a>
						                	<a style="float:right; background-color:#FFDEA9;" href="${pageContext.request.contextPath}/loginTeacher" class="btn btn-sm">강사</a>
						                </p>
						            </div>
						        </div>		
						        <!-- 아이디 -->				        
						        <div class="form-group form-primary">
						            <input id="id" type="text" name="studentId" class="form-control" value="s2" placeholder="Your Id">
						        ...
						        <!-- 패스워드 -->
						        <div class="form-group form-primary">
						            <input id="pw" type="password" name="studentPw" class="form-control" value="1234" placeholder="Password">
						            <span class="form-bar"></span>
						            <label class="float-label"></label>
